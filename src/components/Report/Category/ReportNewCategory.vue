<template>
    <main class="l-main">
        <form :class="['needs-validation', isValidated, 'l-login']" @submit.prevent novalidate>
            <h1 class="mt-4 mb-4 text-center login__title">Criar categoria</h1>
            ...
            <div class="mb-4 login__question">
                ...
                <input type="text" name="title" id="title" :class="['form-control', isValid]"
                    placeholder="Digite o titulo da categoria" :value="$route.params.categoryTitle" required>
            ...
            <div class="mb-4 login__question">
                ...
                <textarea name="description" id="description" :class="['form-control', isValid]"
                    placeholder="Digite a descrição da categoria" required></textarea>
            ...
            <div class="mb-4 login__question">
                ...
                <input type="text" name="keywords" id="keywords" :class="['form-control', isValid]"
                    placeholder="Digite as keywords" :value="$route.params.categoryTitle" required>
            ...
            <div class="mt-2 d-grid">
                <input type="submit" @click="createCategory($event.target.form)" class="btn login__btn" value="Criar">
            </div>
        </form>
    </main>
</template>
